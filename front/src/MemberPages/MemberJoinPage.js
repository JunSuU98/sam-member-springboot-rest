...
function MemberJoinPage(){
    ...
    const [formData, setFormData] = useState({
        ...
        member_create: new Date().toISOString().split('T')[0],
    ...
    return(
        ...
        <Form onSubmit={handleSubmit}>
            ...
            {/* hidden 입력값 */}
            <Form.Group className="mb-3">
                <Form.Control type="hidden" name="member_create" id="member_create" value={formData.memberCreate}/>
            </Form.Group>
            
            <Form.Group className="mb-3">
                <Form.Control type="hidden" name="member_update" id="member_update" value={formData.memberUpdate}/>
            </Form.Group>
